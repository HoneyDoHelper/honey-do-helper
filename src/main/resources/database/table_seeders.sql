...
INSERT INTO honeydoer_reviews (stars, comment, task_id, honeydoer_id) VALUES
       ('5', 'Excellent work on painting the fence. Highly recommended.', 1, 1),
       ('4', 'Very good job on painting the living room, but a bit slow.', 2, 2),
       ('3', 'Installation of the ceiling fan was okay, but not great.', 3, 3),
       ('4', 'Good work on replacing the bathroom sink.', 4, 4),
       ('5', 'Fantastic landscaping job in the front yard!', 5, 5),
       ('4', 'Good job on moving the furniture, but arrived late.', 6, 6),
       ('5', 'Did an excellent job assembling the new dining set.', 7, 7),
       ('4', 'Good work on mounting the TV, but missed a step in the manual.', 8, 8),
       ('5', 'Did a great job cleaning the gutters.', 9, 9),
       ('3', 'Flooring installation was average, not as good as expected.', 10, 10),
       ('4', 'Deck looks much better after the power wash.', 11, 11),
       ('5', 'Installed the kitchen cabinets perfectly!', 12, 12),
       ('4', 'Fence repair was good, but left a small mess in the yard.', 13, 13),
       ('4', 'Removal of wallpaper was done well, but took longer than estimated.', 14, 14),
       ('5', 'Installed the dishwasher quickly and efficiently.', 15, 15),
       ('3', 'House cleaning was average, missed some areas.', 16, 16),
       ('5', 'Organized the garage beautifully! Very pleased with the result.', 17, 17),
       ('4', 'Did a good job replacing the window.', 18, 18),
       ('4', 'Driveway looks cleaner after the power wash.', 19, 19),
       ('5', 'Excellent tile installation in the bathroom.', 20, 20),
       ('5', 'Efficient and thorough cleaning of the attic.', 21, 21);
INSERT INTO client_reviews (stars, comment, task_id, user_id) VALUES
      ('5', 'Very responsible and respectful client.', 1, 1),
      ('4', 'Good client but needed more clarity in task description.', 2, 2),
      ('3', 'Client was difficult to work with.', 3, 3),
      ('4', 'Overall a pleasant experience working with this client.', 4, 4),
      ('5', 'Excellent client! Clear instructions and prompt payment.', 5, 5),
      ('4', 'Good client but there were delays in communication.', 6, 6),
      ('5', 'Amazing client! Would love to work again with them.', 7, 7),
      ('4', 'Client was good but there were some issues with payment.', 8, 8),
      ('5', 'Client was understanding and easy to work with.', 9, 9),
      ('3', 'Had difficulties understanding client’s expectations.', 10, 10),
      ('4', 'Good client, but there were issues with task scheduling.', 11, 11),
      ('5', 'Great client! Clear instructions and easy communication.', 12, 12),
      ('4', 'Client was good, but there were some last minute changes.', 13, 13),
      ('4', 'Client was good but had unrealistic expectations.', 14, 14),
      ('5', 'Excellent client! Very professional and understanding.', 15, 15),
      ('3', 'Client was difficult to communicate with.', 16, 16),
      ('5', 'Great client! Always available for clarifications.', 17, 17),
      ('4', 'Good client but needs to work on their communication.', 18, 18),
      ('4', 'Client was good but had some issues with payment.', 19, 19),
      ('5', 'Excellent client! Very clear and concise instructions.', 20, 20),
      ('5', 'Amazing client! Would love to work again with them.', 21, 21);
